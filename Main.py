...
from Features.playmusic import PlayMusic
...
def TrainTasks():
    ...
    with open("C:\\Users\\RITESH YADAV\\Desktop\\AI Voice Assistant\\Data\\Tasks.json",'r') as f:
        intents = json.load(f)
    ...
    FILE = "C:\\Users\\RITESH YADAV\\Desktop\\AI Voice Assistant\\DataBase\\Tasks.pth"
...
def TasksExecutor(query):
    ...
    with open('C:\\Users\\RITESH YADAV\\Desktop\\AI Voice Assistant\\Data\\Tasks.json','r') as json_data:
